...
// Autogenerated from wled00/data/fr/usermod.htm, do not edit!!
const char PAGE_usermod[] PROGMEM = R"=====(<!DOCTYPE html><html><body>Pas de page web custom dans les mods utilisateurs.
</body></html>)=====";


// Autogenerated from wled00/data/fr/msg.htm, do not edit!!
const char PAGE_msg[] PROGMEM = R"=====(<!DOCTYPE html><html><head><meta content="width=device-width" name="viewport">
<title>Message WLED</title><script>
...
</style></head><body><h2>%MSG%</body>
</html>)=====";


#ifdef WLED_ENABLE_DMX

// Autogenerated from wled00/data/fr/dmxmap.htm, do not edit!!
const char PAGE_dmxmap[] PROGMEM = R"=====(<!DOCTYPE html><html><head><meta content="width=device-width" name="viewport">
<title>Mapping DMX</title><script>
function B(){window.history.back()}function RS(){window.location="/settings"}function RP(){top.location.href="/"}function FM() {%DMXVARS%
var n=["À 0","ROUGE","VERT","BLEU","BLANC","SHUTTER","À 255","DÉSACTIVÉ"],o=[];for(i=0;i<512;i++)o.push(7);for(i=0;i<LC;i++)for(FS=CS+CG*i,j=0;j<CN;j++)DA=FS+j,o[DA-1]=CH[j];for(DMXMap="",i=0;i<512;i++)DMXMap+='<div class="anytype type'+o[i]+'">'+String(i+1)+"<br />"+n[o[i]]+"</div>";document.getElementById("map").innerHTML=DMXMap}
</script><style>
...
</style></head><body><h2>Mis à jour logiciel de WLED</h2><form method="POST" 
action="/update" id="uf" enctype="multipart/form-data" onsubmit="U()">
Version installée: 0.13.0-b6<br>Télécharger le dernier firmware: <a 
href="https://github.com/Aircoookie/WLED/releases" target="_blank"><img 
src="https://img.shields.io/github/release/Aircoookie/WLED.svg?style=flat-square">
</a><br><input type="file" class="bt" name="update" required><br><input 
type="submit" class="bt" value="Mis à jour !"><br><button type="button" 
class="bt" onclick="B()">Retour</button></form><div id="msg"><b>
En cours de mis à jour...</b><br>Veuillez ne pas fermer ou recharger la page :)
</div></body></html>)=====";


// Autogenerated from wled00/data/fr/welcome.htm, do not edit!!
...
content="#222222"><title>Bienvenue !</title><style>
...
<div class="main"><h1>Bienvenue sur WLED !</h1><h3>
Merci d'avoir installer mon application !</h3><b>Prochaine étape:</b><br><br>
Connectez le module à votre WiFi ici !<br><button 
onclick='window.location.href="/settings/wifi"'>Paramètres WiFi</button><br><i>
Ou testez le mode Point d'accès ?</i><br><button 
onclick='window.location.href="/sliders"'>Vers les contrôles !</button><br>
</div></body></html>)=====";


// Autogenerated from wled00/data/fr/liveview.htm, do not edit!!
...
WLED prévisualisation en temps réel</title><style>
...
// Autogenerated from wled00/data/fr/liveviewws.htm, do not edit!!
...
// Autogenerated from wled00/data/fr/404.htm, do not edit!!
...
<h1>404 Non Trouvée</h1><b>Akemi ne sait pas où vous avez été dirigé...</b><br>
<br><button onclick='window.location.href="/sliders"'>Retour aux contrôles
</button></body></html>)=====";


// Autogenerated from wled00/data/fr/favicon.ico, do not edit!!
